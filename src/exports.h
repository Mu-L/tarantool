...
EXPORT(uuid_unpack)
EXPORT_ICU(u_strlen)
EXPORT_ICU(u_uastrcpy)
EXPORT_ICU(u_austrcpy)
EXPORT_ICU(u_errorName)
EXPORT_ICU(u_getVersion)
EXPORT_ICU(udat_open)
EXPORT_ICU(udat_setLenient)
EXPORT_ICU(udat_close)
EXPORT_ICU(udat_parseCalendar)
EXPORT_ICU(udat_formatCalendar)
EXPORT_ICU(ucal_open)
EXPORT_ICU(ucal_close)
EXPORT_ICU(ucal_get)
EXPORT_ICU(ucal_set)
EXPORT_ICU(ucal_add)
EXPORT_ICU(ucal_clear)
EXPORT_ICU(ucal_clearField)
EXPORT_ICU(ucal_getMillis)
EXPORT_ICU(ucal_setMillis)
EXPORT_ICU(ucal_getAttribute)
EXPORT_ICU(ucal_setAttribute)
EXPORT_ICU(ucal_getTimeZoneID)
EXPORT_ICU(ucal_setTimeZone)
EXPORT_ICU(ucal_getNow)
